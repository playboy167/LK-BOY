...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/playboy167/BLACK-HAT-/tree/main').text
			if basesplit in plr:
				key = basesplit
...
╚═════╝ ╚═╝  ╚═╝      ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝ 
\033[1;90m═══════════════════════════════════════════════════════════
\033[1;94m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : レイハン・アハメド・ブボン'
\033[1;95m [\033[1;94m✯\033[1;91m] \033[1;92mWHATSUP  : +8801979526394
\033[1;93m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB      : 👿DX-PLAY👿
